...
from model_unet_model import UNet
from model_load_data import make_dataloaders
from model_eval import eval_net_loader
from model_utils import make_checkpoint_dir
#from model import UNet, make_dataloaders, eval_net_loader, make_checkpoint_dir
from lib_visualization import plot_net_predictions
...
def train_epoch(epoch,train_loader,criterion,optimizer,batch_size,scheduler):
    ...
    for i, sample_batch in enumerate(train_loader, 1):
...
def train_net(train_loader, val_loader, net, device, epochs=200, batch_size=1, lr=0.001, save_cp=True):
...
def get_args():
    ...
    parser.add_option('-f', '--folder', dest="C:\\Users\\ABDEL\\Downloads\\unet-multiclass-pytorch-master\\unet-multiclass-pytorch-master\\_code ensemble", 
